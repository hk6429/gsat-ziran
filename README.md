...
- 第一批 40 題國中補救教學解析，由地科、物理、化學、生物四科教師逐題覆核，含正向提示、分步推理與完整選項說明
- 115 學年度 48 題官方全體、高分組、低分組選項畫記率；數值直接轉錄官方資料，不由整題答對率反推
- 首頁提供今日複習、錯題本、學習歷程、整回模考與教師出卷模式

## 官方資料來源

- [大考中心學測歷年一般試題](https://www.ceec.edu.tw/xmfile?xsmsid=0j052424829869345634)
- 83、84、85、86、87、88、89、90、91、92、93、94、95、96、97、98、99、100、101、102、103、104、105、106、107、108、109、110、111、112、113、114、115 學測自然試題、選擇題參考答案、非選擇題評分原則與選項分析
...
scripts/build-learning-data.mjs 由官方統計文字檔重建選項畫記率
