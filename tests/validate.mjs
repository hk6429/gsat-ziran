...
check(banks.length === 12, "題庫必須正好載入 104–115 十二個學年度");
check(banks.map(bank => bank.year).join(",") === "115,114,113,112,111,110,109,108,107,106,105,104", "題庫年份必須為 104–115");
...
console.log(
  `VALIDATE=PASS years=115,114,113,112,111,110,109,108,107,106,105,104 questions=${totalQuestions} choices=${totalChoices} ` +
